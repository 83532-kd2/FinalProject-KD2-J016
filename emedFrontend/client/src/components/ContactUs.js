...
const ContactUs = () => {
  return (
    <div className="flex">
      <Sidebar />
      <div className="ml-25 p-8 w-full">
        <section className="text-center bg-white p-10 rounded-lg shadow-lg">
          <h1 className="text-4xl font-bold text-gray-800 mb-6">Contact Us</h1>
          <p className="text-lg text-gray-600 mb-8 leading-relaxed">
            We're here to help you with any questions or concerns you may have
            about your healthcare experience. Whether you need assistance with
            booking appointments, managing your profile, or understanding the
            services offered by our partner doctors and clinics, our team is
            ready to assist. Please feel free to reach out to us using the
            contact details below. Your health and satisfaction are our top
            priorities, and we're committed to providing you with the support
            you need for a seamless and stress-free experience.
          </p>
        </section>
